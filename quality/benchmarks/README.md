...
- BenchmarkDotNet exported suite reports beneath `.artifacts/bdn/results` by
  default. The baseline launcher writes each filtered suite under
  `.artifacts/bdn/baseline/<Job>/<Suite>/`.
