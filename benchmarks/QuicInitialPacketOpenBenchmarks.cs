...
/// <summary>
/// Benchmarks Initial packet opening through the handshake flow coordinator.
/// </summary>
[MemoryDiagnoser]
public class QuicInitialPacketOpenBenchmarks
{
    ...
    private QuicHandshakeFlowCoordinator coordinator = default!;
    private QuicInitialPacketProtection protection = default!;
    ...
    public void GlobalSetup()
    {
        ...
        coordinator = new QuicHandshakeFlowCoordinator(
            initialDestinationConnectionId: ClientInitialDcid,
    ...
    /// <summary>
    /// Measures protected Initial packet opening through the current byte-array API.
    /// </summary>
    [Benchmark]
    public int OpenInitialPacketAsArray()
    {
    ...
    /// <summary>
    /// Measures protected Initial packet opening through pooled lease ownership.
    /// </summary>
    [Benchmark]
    public int OpenInitialPacketAsLease()
    {
        if (!coordinator.TryOpenInitialPacketLease(
                protectedPacket,
                protection,
