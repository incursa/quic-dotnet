...
- [`Invoke-QuicInteropAutopilot.ps1`](Invoke-QuicInteropAutopilot.ps1): builds the interop-first lane catalog, manages disposable worker worktrees, launches the worker autopilot, and cherry-picks verified lane commits back to `main`
