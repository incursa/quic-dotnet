...
function Get-LaneTemplateDefinitions {
    return @(
        ...
        [pscustomobject]@{
            ...
            requirement_families = @("REQ-QUIC-RFC9000-S3P1-0013", "REQ-QUIC-RFC9000-S3P1-0014", "REQ-QUIC-RFC9000-S3P1-0015", "RFC9000-S3-1-P10-R01", "REQ-QUIC-RFC9000-S3P1-0017", "REQ-QUIC-RFC9000-S13P3-0011", "REQ-QUIC-RFC9000-0795")
            verification_commands = @(
        ...
        [pscustomobject]@{
            ...
            requirement_families = @("RFC9000-S9-4-P1-S2-R01", "RFC9000-S9-4-P2-S1-R01", "REQ-QUIC-RFC9000-S9P4-0003", "REQ-QUIC-RFC9000-S9P4-0005")
            verification_commands = @(
        ...
        [pscustomobject]@{
            ...
            requirement_families = @(
                "RFC9000-S9-3-P4-S1-R01",
                "REQ-QUIC-RFC9000-S9P3-0003",
                "RFC9000-S9-3-P4-S2-R01",
