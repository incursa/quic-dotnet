...
- [`artifacts/`](artifacts): generated outputs only

## Specs Tree

- [`specs/requirements/spec-trace/`](specs/requirements/spec-trace/): the canonical spec-trace standard
...
- [`specs/templates/`](specs/templates/README.md): copy-ready artifact templates
