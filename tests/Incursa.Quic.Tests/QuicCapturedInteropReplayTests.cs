...
public sealed class QuicCapturedInteropReplayTests
{
    ...
    private static readonly byte[] CapturedNgtcp2ClientSourceConnectionId = Convert.FromHexString("5ECC08BEE8DA01D1");
    private static readonly byte[] CapturedNgtcp2ServerTrafficSecret = Convert.FromHexString(
        // Captured from:
        // C:\src\incursa\quic-dotnet\.artifacts\interop-runner\ngtcp2-app-rx-debug3\20260519-002720755-client-chrome\
        //   runner-logs\ngtcp2_chrome\handshake\client\keys.log
        // SERVER_TRAFFIC_SECRET_0 for ngtcp2 packet 65 / packet number 399463276.
        "16A3D6DAEE9059CE3C134D11838B76C83C9779A432FB8BAFFB972F9F1C3777EE");
    private static readonly byte[] CapturedNgtcp2ServerResponsePacket = Convert.FromHexString(
        // Captured from:
        // C:\src\incursa\quic-dotnet\.artifacts\interop-runner\ngtcp2-app-rx-debug3\20260519-002720755-client-chrome\
        //   runner-logs\ngtcp2_chrome\handshake\sim\trace_node_left.pcap
        // Packet 65: server -> client short 1-RTT packet, packet number 399463276 truncated to one byte.
        "");
    ...
    [Fact]
    public void CapturedNgtcp2ServerResponsePacketNeedsExpandedPacketNumberForTheAeadNonce()
    {
        const ulong expectedPacketNumber = 399463276;

        Assert.True(TryCreateOneRttPacketProtectionMaterial(
            CapturedNgtcp2ServerTrafficSecret,
            out QuicTlsPacketProtectionMaterial openMaterial));

        QuicHandshakeFlowCoordinator coordinator = new(CapturedNgtcp2ClientSourceConnectionId);
        Assert.False(coordinator.TryOpenProtectedApplicationDataPacket(
            CapturedNgtcp2ServerResponsePacket,
            openMaterial,
            out _,
            out _,
            out _,
        ...
        Assert.False(observedKeyPhase);
        Assert.Equal(
            "ack(largest=3,first=3,ranges=0),stream(id=0,off=0,len=1024,fin=True,data=1C1B28C6A841F068),padding(138)",
            DescribeFrames(openedPacket.AsSpan(payloadOffset, payloadLength)));
    }
