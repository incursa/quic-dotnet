...
public sealed class REQ_QUIC_CRT_0063
{
    ...
    public void PacketFromANewAddressBeforeHandshakeConfirmationCreatesACandidatePathAndProbe()
    {
        ...
        Assert.Equal(QuicVersionNegotiation.Version1MinimumDatagramPayloadSize, candidatePath.AmplificationState.ReceivedPayloadBytes);
        Assert.Equal(QuicVersionNegotiation.Version1MinimumDatagramPayloadSize, candidatePath.AmplificationState.SentPayloadBytes);
