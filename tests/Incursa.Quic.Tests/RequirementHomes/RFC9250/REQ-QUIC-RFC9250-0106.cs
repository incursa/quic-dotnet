...
public sealed class REQ_QUIC_RFC9250_0106
{
    ...
    public void DoqAddressValidationTokenPolicyTraceArtifactsAreLinked()
    {
        ...
        Assert.Contains("REQ-QUIC-RFC9250-0106", spec, StringComparison.Ordinal);
        ...
        Assert.Contains("REQ-QUIC-RFC9250-0106", architecture, StringComparison.Ordinal);
        Assert.Contains("REQ-QUIC-RFC9250-0106", workItem, StringComparison.Ordinal);
        Assert.Contains("REQ-QUIC-RFC9250-0106", verification, StringComparison.Ordinal);
    }
