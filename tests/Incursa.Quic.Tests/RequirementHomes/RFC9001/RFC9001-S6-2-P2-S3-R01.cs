...
///   <workbench-requirement requirementId="RFC9001-S6-2-P2-S3-R01">If a peer initiates a key update, the endpoint MUST update its send keys to the corresponding key phase before sending an acknowledgment for a packet that was received with updated keys.</workbench-requirement>
/// </workbench-requirements>
[Requirement("RFC9001-S6-2-P2-S3-R01")]
public sealed class RFC9001_S6_2_P2_S3_R01
{
    [Fact]
