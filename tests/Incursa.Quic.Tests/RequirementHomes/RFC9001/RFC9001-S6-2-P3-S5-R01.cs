...
///   <workbench-requirement requirementId="RFC9001-S6-2-P3-S5-R01">An endpoint MAY treat consecutive peer key updates that occur before confirmation of the prior update as a connection error of type KEY_UPDATE_ERROR.</workbench-requirement>
/// </workbench-requirements>
[Requirement("RFC9001-S6-2-P3-S5-R01")]
public sealed class RFC9001_S6_2_P3_S5_R01
{
    [Fact]
