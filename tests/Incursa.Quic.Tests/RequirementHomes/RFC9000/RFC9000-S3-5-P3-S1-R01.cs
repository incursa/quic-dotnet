...
///   <workbench-requirement requirementId="RFC9000-S3-5-P3-S1-R01">STREAM frames received after sending a STOP_SENDING frame MUST still be counted toward connection and stream flow control even if they are discarded upon receipt.</workbench-requirement>
/// </workbench-requirements>
[Requirement("RFC9000-S3-5-P3-S1-R01")]
public sealed class RFC9000_S3_5_P3_S1_R01
{
