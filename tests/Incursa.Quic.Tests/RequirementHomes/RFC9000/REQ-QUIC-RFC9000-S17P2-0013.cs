...
///   <workbench-requirement requirementId="REQ-QUIC-RFC9000-S17P2-0013">The most significant bit (0x80) of byte 0 (the first byte) MUST be set to 1 for long headers.</workbench-requirement>
