...
///   <workbench-requirement requirementId="REQ-QUIC-RFC9000-S22P1P2-0003">Reserve first unassigned codepoint for Standards Action</workbench-requirement>
/// </workbench-requirements>
[Requirement("REQ-QUIC-RFC9000-S22P1P2-0003")]
public sealed class REQ_QUIC_RFC9000_S22P1P2_0003
{
    [Fact]
    [CoverageType(RequirementCoverageType.Positive)]
    [Trait("Category", "Positive")]
    public void RequirementStatement_ReservesFirstUnassignedCodepointForStandardsAction()
    {
