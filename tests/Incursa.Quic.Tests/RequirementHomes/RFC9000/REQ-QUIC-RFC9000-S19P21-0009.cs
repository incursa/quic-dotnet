...
[Requirement("REQ-QUIC-RFC9000-S19P21-0009")]
public sealed class REQ_QUIC_RFC9000_S19P21_0009
{
    [Fact]
    [Requirement("REQ-QUIC-RFC9000-S19P21-0009")]
    ...
    {
        var requirement = QuicRfc9000RequirementSpecSupport.GetRequirement("REQ-QUIC-RFC9000-S19P21-0009");

        Assert.Equal("Extension frames MUST cause an ACK frame to be sent.", requirement.GetProperty("statement").GetString());
        Assert.Contains("#section-19.21", QuicRfc9000RequirementSpecSupport.GetUpstreamRef("REQ-QUIC-RFC9000-S19P21-0009"));
    }
    ...
    {
        string statement = QuicRfc9000RequirementSpecSupport.GetStatement("REQ-QUIC-RFC9000-S19P21-0009");
