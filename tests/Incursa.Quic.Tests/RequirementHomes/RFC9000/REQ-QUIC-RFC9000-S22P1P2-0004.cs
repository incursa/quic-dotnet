...
///   <workbench-requirement requirementId="REQ-QUIC-RFC9000-S22P1P2-0004">Allow early codepoint assignment for selected values</workbench-requirement>
/// </workbench-requirements>
[Requirement("REQ-QUIC-RFC9000-S22P1P2-0004")]
public sealed class REQ_QUIC_RFC9000_S22P1P2_0004
{
    [Fact]
    [CoverageType(RequirementCoverageType.Positive)]
    [Trait("Category", "Positive")]
    public void RequirementStatement_AllowsEarlyCodepointAssignmentForSelectedValues()
    {
