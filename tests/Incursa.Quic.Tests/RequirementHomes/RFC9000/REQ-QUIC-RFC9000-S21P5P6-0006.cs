...
///   <workbench-requirement requirementId="REQ-QUIC-RFC9000-S21P5P6-0006">Endpoints MAY retire connection IDs containing patterns known to be problematic without using them.</workbench-requirement>
/// </workbench-requirements>
[Requirement("REQ-QUIC-RFC9000-S21P5P6-0006")]
public sealed class REQ_QUIC_RFC9000_S21P5P6_0006
{
    [Fact]
    ...
    {
        JsonElement requirement = GetRequirement("REQ-QUIC-RFC9000-S21P5P6-0006");
        ...
        Assert.Equal("RFC 9000 §21.5.6 RFC9000-S21.5.6-B6-P5-S4", requirement.GetProperty("trace").GetProperty("upstream_refs")[0].GetString());
    }
    ...
    {
        string statement = GetRequirement("REQ-QUIC-RFC9000-S21P5P6-0006").GetProperty("statement").GetString() ?? string.Empty;
