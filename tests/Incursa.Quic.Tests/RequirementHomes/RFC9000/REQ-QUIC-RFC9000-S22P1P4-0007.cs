...
///   <workbench-requirement requirementId="REQ-QUIC-RFC9000-S22P1P4-0007">All registrations in this document MUST be assigned a permanent status.</workbench-requirement>
/// </workbench-requirements>
[Requirement("REQ-QUIC-RFC9000-S22P1P4-0007")]
public sealed class REQ_QUIC_RFC9000_S22P1P4_0007
{
    [Fact]
    [CoverageType(RequirementCoverageType.Positive)]
    [Trait("Category", "Positive")]
    public void RequirementStatement_AssignsDocumentRegistrationsPermanentStatus()
    {
