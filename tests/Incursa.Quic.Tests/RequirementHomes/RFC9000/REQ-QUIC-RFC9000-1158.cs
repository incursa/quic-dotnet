...
///   <workbench-requirement requirementId="REQ-QUIC-RFC9000-1158">An endpoint that receives a value less than 2 MUST close the connection with an error of type TRANSPORT_PARAMETER_ERROR.</workbench-requirement>
/// </workbench-requirements>
[Requirement("REQ-QUIC-RFC9000-1158")]
public sealed class REQ_QUIC_RFC9000_1158
{
    [Fact]
    ...
    public void TryParseTransportParameters_AcceptsActiveConnectionIdLimitAtTwo()
    {
        byte[] encoded = QuicTransportParameterTestData.BuildTransportParameterTuple(
            0x0E,
