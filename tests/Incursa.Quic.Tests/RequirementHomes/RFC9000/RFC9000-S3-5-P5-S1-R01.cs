...
///   <workbench-requirement requirementId="RFC9000-S3-5-P5-S1-R01">An endpoint SHOULD copy the error code from the STOP_SENDING frame to the RESET_STREAM frame it sends.</workbench-requirement>
