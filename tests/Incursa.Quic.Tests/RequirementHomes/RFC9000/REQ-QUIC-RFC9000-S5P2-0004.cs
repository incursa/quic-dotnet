...
public sealed class REQ_QUIC_RFC9000_S5P2_0004
{
    [Fact]
    [CoverageType(RequirementCoverageType.Positive)]
    [Trait("Category", "Positive")]
    public void EndpointProcessesPacketWithMatchingNonZeroDestinationConnectionId()
    {
    ...
    public void EndpointDoesNotProcessPacketWithDifferentNonZeroDestinationConnectionId()
    {
        var scenario = QuicS5P2PacketAssociationTestSupport.CreateRegisteredEndpoint(
            QuicS5P2PacketAssociationTestSupport.RouteConnectionId);
        using QuicConnectionRuntime runtime = scenario.Runtime;
    ...
    [Trait("Category", "Edge")]
    public void EndpointProcessesPacketWithMaximumLengthDestinationConnectionIdRoute()
    {
        ...
        QuicConnectionIngressResult result = endpoint.ReceiveDatagram(
            QuicS5P2PacketAssociationTestSupport.BuildHandshakeDatagram(maximumLengthConnectionId),
            QuicS5P2P2ServerPreAcceptanceTestSupport.CreatePathIdentity());
