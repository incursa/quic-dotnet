...
///   <workbench-requirement requirementId="RFC9000-S22-1-2-P1-R01">New requests for codepoints from QUIC registries SHOULD use a randomly selected codepoint that excludes both existing allocations and the first unallocated codepoint in the selected space.</workbench-requirement>
/// </workbench-requirements>
[Requirement("RFC9000-S22-1-2-P1-R01")]
public sealed class REQ_QUIC_RFC9000_S22P1P2_0001
{
    ...
    public void RequirementStatement_UsesRandomSelectionPolicyForNewRegistryRequests()
    {
        ...
        JsonElement requirement = document.RootElement
            ...
            .EnumerateArray()
            .Single(entry => entry.GetProperty("id").GetString() == "RFC9000-S22-1-2-P1-R01");
