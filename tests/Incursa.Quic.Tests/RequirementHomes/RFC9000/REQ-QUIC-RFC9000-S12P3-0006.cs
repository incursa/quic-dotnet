...
public sealed class REQ_QUIC_RFC9000_S12P3_0006
{
    ...
    public void PacketNumbersStartAtZeroInEachSpace()
    {
        byte[] initialDcid =
        [
        ...
        Assert.Equal(0UL, initialPacketNumber);
        Assert.Equal(0UL, handshakePacketNumber);
        Assert.Equal(0UL, applicationPacketNumber);
    }
}
