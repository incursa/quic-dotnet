...
///   <workbench-requirement requirementId="REQ-QUIC-RFC9000-S3P5-0013">An endpoint MAY encourage prompt termination in the opposite direction by sending a STOP_SENDING frame.</workbench-requirement>
/// </workbench-requirements>
[Requirement("REQ-QUIC-RFC9000-S3P5-0013")]
public sealed class REQ_QUIC_RFC9000_S3P5_0013
{
    ...
    public async Task AbortStreamReadsAsync_EmitsStopSendingAndRaisesLocalReadAbortedNotification()
    {
