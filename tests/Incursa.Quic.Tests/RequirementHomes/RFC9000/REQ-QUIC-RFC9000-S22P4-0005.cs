...
///   <workbench-requirement requirementId="REQ-QUIC-RFC9000-S22P4-0005">In addition to the advice in Section 22.1, specifications for new permanent registrations SHOULD describe the means by which an endpoint might determine that it can send the identified type of frame.</workbench-requirement>
/// </workbench-requirements>
[Requirement("REQ-QUIC-RFC9000-S22P4-0005")]
public sealed class REQ_QUIC_RFC9000_S22P4_0005
{
    [Fact]
    [CoverageType(RequirementCoverageType.Positive)]
    [Trait("Category", "Positive")]
    public void RequirementStatement_DescribesHowEndpointsDetermineTheyCanSendFrameTypes()
    {
