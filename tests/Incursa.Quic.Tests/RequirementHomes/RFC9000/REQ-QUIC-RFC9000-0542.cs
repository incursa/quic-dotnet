...
public sealed class REQ_QUIC_RFC9000_0542
{
    [Fact]
    [CoverageType(RequirementCoverageType.Positive)]
    [Trait("Category", "Positive")]
    public void ProbePacketsFromADifferentSourceInitiateClientAddressValidation()
    {
        ...
        byte[] preferredIpv4Address = [198, 51, 100, 36];
        byte[] preferredIpv6Address = [0x20, 0x01, 0x0D, 0xB8, 0x00, 0x01, 0x00, 0x02, 0x00, 0x03, 0x00, 0x04, 0x00, 0x05, 0x00, 0x24];
        ...
        QuicConnectionPathIdentity activePath = new("203.0.113.36", RemotePort: 443);
        QuicConnectionPathIdentity preferredPath = new("198.51.100.36", RemotePort: 9453);
        ...
        Assert.NotEmpty(candidatePath.Validation.ChallengePayload.ToArray());
