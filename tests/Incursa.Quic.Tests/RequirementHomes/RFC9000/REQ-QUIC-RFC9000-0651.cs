...
///   <workbench-requirement requirementId="RFC9000-S10-3-2-P6-S1-R01">The same stateless reset token MUST NOT be used for multiple connection IDs.</workbench-requirement>
