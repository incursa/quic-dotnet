...
///   <workbench-requirement requirementId="RFC9000-S22-1-3-P3-S1-R01">If any use of the codepoints is identified by this search or a request to update the registration is made, the codepoint MUST NOT be reclaimed.</workbench-requirement>
/// </workbench-requirements>
[Requirement("RFC9000-S22-1-3-P3-S1-R01")]
public sealed class RFC9000_S22_1_3_P3_S1_R01
{
    [Fact]
    ...
    public void RequirementStatement_UsesNoReclaimRuleWhenUseIsIdentified()
    {
        ...
        JsonElement requirement = document.RootElement
            ...
            .EnumerateArray()
            .Single(entry => entry.GetProperty("id").GetString() == "RFC9000-S22-1-3-P3-S1-R01");
