...
///   <workbench-requirement requirementId="REQ-QUIC-RFC9000-S22P1P3-0004">If no use of the codepoint was identified and no request was made to update the registration, the codepoint MAY be removed from the registry.</workbench-requirement>
/// </workbench-requirements>
[Requirement("REQ-QUIC-RFC9000-S22P1P3-0004")]
public sealed class REQ_QUIC_RFC9000_S22P1P3_0004
{
    [Fact]
    ...
    public void RequirementStatement_UsesRemovalPermissionWhenNoUseIsIdentified()
    {
        ...
        JsonElement requirement = document.RootElement
            ...
            .EnumerateArray()
            .Single(entry => entry.GetProperty("id").GetString() == "REQ-QUIC-RFC9000-S22P1P3-0004");

        Assert.Equal("If no use of the codepoint was identified and no request was made to update the registration,...", requirement.GetProperty("title").GetString());
        Assert.Equal(
        ...
        Assert.Equal("RFC 9000 §22.1.3 RFC9000-S22.1.3-B5-P4-S1", requirement.GetProperty("trace").GetProperty("upstream_refs")[0].GetString());
    }
