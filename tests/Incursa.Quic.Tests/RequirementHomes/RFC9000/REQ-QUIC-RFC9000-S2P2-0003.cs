...
///   <workbench-requirement requirementId="REQ-QUIC-RFC9000-S2P2-0003">Endpoints MUST be able to deliver stream data to an application as an ordered byte stream.</workbench-requirement>
/// </workbench-requirements>
[Requirement("REQ-QUIC-RFC9000-S2P2-0003")]
public sealed class REQ_QUIC_RFC9000_S2P2_0003
{
    [Fact]
    [Requirement("REQ-QUIC-RFC9000-S2P2-0003")]
