...
///   <workbench-requirement requirementId="REQ-QUIC-RFC9000-S21P5-0003">Any future extension that allows server migration MUST also define countermeasures for forgery attacks.</workbench-requirement>
/// </workbench-requirements>
[Requirement("REQ-QUIC-RFC9000-S21P5-0003")]
public sealed class REQ_QUIC_RFC9000_S21P5_0003
{
    [Fact]
    ...
    {
        JsonElement requirement = GetRequirement("REQ-QUIC-RFC9000-S21P5-0003");
        ...
        Assert.Equal("RFC 9000 §21.5 RFC9000-S21.5-B9-P8-S2", requirement.GetProperty("trace").GetProperty("upstream_refs")[0].GetString());
    }
    ...
    {
        string statement = GetRequirement("REQ-QUIC-RFC9000-S21P5-0003").GetProperty("statement").GetString() ?? string.Empty;
