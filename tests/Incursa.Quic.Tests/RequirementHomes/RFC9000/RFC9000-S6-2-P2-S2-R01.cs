...
public sealed class REQ_QUIC_RFC9000_6223
{
    ...
    ///   <workbench-requirement requirementId="RFC9000-S6-2-P2-S1-R01">A client MUST discard any Version Negotiation packet if it has received and successfully processed any other packet, including an earlier Version Negotiation packet.</workbench-requirement>
