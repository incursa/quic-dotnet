...
///   <workbench-requirement requirementId="REQ-QUIC-RFC9000-S17P4-0007">When the spin bit is disabled, endpoints MUST ignore any incoming value.</workbench-requirement>
/// </workbench-requirements>
[Requirement("REQ-QUIC-RFC9000-S17P4-0007")]
public sealed class REQ_QUIC_RFC9000_S17P4_0007
{
    [Theory]
    [InlineData(false)]
    [InlineData(true)]
