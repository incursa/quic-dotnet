...
///   <workbench-requirement requirementId="REQ-QUIC-RFC9000-S8P1P3-0009">A client SHOULD include an applicable, unused token in an Initial packet.</workbench-requirement>
/// </workbench-requirements>
[Requirement("REQ-QUIC-RFC9000-S8P1P3-0009")]
public sealed class REQ_QUIC_RFC9000_S8P1P3_0009
{
    [Fact]
