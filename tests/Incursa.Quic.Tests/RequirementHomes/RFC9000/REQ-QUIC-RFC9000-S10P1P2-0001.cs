...
///   <workbench-requirement requirementId="REQ-QUIC-RFC9000-S10P1P2-0001">Application protocols that use QUIC SHOULD provide guidance on when deferring an idle timeout is appropriate.</workbench-requirement>
/// </workbench-requirements>
[Requirement("REQ-QUIC-RFC9000-S10P1P2-0001")]
public sealed class REQ_QUIC_RFC9000_S10P1P2_0001
{
    [Fact]
