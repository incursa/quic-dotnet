...
///   <workbench-requirement requirementId="REQ-QUIC-RFC9000-S10P2P1-0009">In the closing state, an endpoint MUST retain only enough information to generate a packet containing a CONNECTION_CLOSE frame and to identify packets as belonging to the connection.</workbench-requirement>
/// </workbench-requirements>
[Requirement("REQ-QUIC-RFC9000-S10P2P1-0009")]
public sealed class REQ_QUIC_RFC9000_S10P2P1_0009
{
    [Fact]
