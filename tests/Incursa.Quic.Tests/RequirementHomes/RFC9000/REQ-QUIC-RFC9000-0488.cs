...
///   <workbench-requirement requirementId="REQ-QUIC-RFC9000-0488">After verifying a new client address, the server SHOULD send new address validation tokens to the client.</workbench-requirement>
/// </workbench-requirements>
[Requirement("REQ-QUIC-RFC9000-0488")]
public sealed class REQ_QUIC_RFC9000_0488
{
    [Fact]
