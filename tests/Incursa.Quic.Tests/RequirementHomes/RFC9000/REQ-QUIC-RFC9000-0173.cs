...
///   <workbench-requirement requirementId="REQ-QUIC-RFC9000-0173">A receiver MUST close the connection with an error of type FLOW_CONTROL_ERROR if the sender violates the advertised connection or stream data limits.</workbench-requirement>
/// </workbench-requirements>
[Requirement("REQ-QUIC-RFC9000-0173")]
public sealed class REQ_QUIC_RFC9000_0173
{
    [Fact]
    [CoverageType(RequirementCoverageType.Positive)]
    [Trait("Category", "Positive")]
    public void TryReceiveStreamFrame_AcceptsFramesWithinTheAdvertisedLimits()
    {
        ...
        Assert.True(limitedCredit.TryGetStreamSnapshot(1, out QuicConnectionStreamSnapshot snapshot));
