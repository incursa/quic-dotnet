...
public sealed class REQ_QUIC_RFC9000_S14_0003
{
    ...
    ///   <workbench-requirement requirementId="REQ-QUIC-RFC9000-0856">QUIC MUST NOT be used if the network path cannot support a maximum datagram size of at least 1200 bytes.</workbench-requirement>
    ///   <workbench-requirement requirementId="REQ-QUIC-RFC9000-0281">Clients that support multiple QUIC versions SHOULD ensure that the first UDP datagram they send is sized to the largest of the minimum datagram sizes from all versions they support, using PADDING frames as necessary.</workbench-requirement>
