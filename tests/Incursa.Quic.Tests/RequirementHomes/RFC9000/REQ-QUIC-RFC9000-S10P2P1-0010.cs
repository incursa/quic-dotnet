...
///   <workbench-requirement requirementId="REQ-QUIC-RFC9000-S10P2P1-0010">An endpoint in the closing state MUST send a packet containing a CONNECTION_CLOSE frame in response to any incoming packet that it attributes to the connection.</workbench-requirement>
/// </workbench-requirements>
[Requirement("REQ-QUIC-RFC9000-S10P2P1-0010")]
public sealed class REQ_QUIC_RFC9000_S10P2P1_0010
{
    [Fact]
