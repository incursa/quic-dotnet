...
///   <workbench-requirement requirementId="REQ-QUIC-RFC9000-S10P3-0008">For the Stateless Reset to appear as a valid QUIC packet, the Unpredictable Bits field MUST include at least 38 bits of data.</workbench-requirement>
