...
///   <workbench-requirement requirementId="REQ-QUIC-RFC9000-S10P2P1-0001">An endpoint SHOULD limit the rate at which it generates packets in the closing state.</workbench-requirement>
/// </workbench-requirements>
[Requirement("REQ-QUIC-RFC9000-S10P2P1-0001")]
public sealed class REQ_QUIC_RFC9000_S10P2P1_0001
{
    [Fact]
