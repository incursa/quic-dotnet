...
///   <workbench-requirement requirementId="REQ-QUIC-RFC9000-0412">If the client IP address has changed, the server MUST adhere to the anti-amplification limit.</workbench-requirement>
/// </workbench-requirements>
[Requirement("REQ-QUIC-RFC9000-0412")]
public sealed class REQ_QUIC_RFC9000_0412
{
    [Fact]
