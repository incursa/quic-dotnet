...
///   <workbench-requirement requirementId="REQ-QUIC-RFC9000-S11P2-0003">A stream MUST only be terminated by the application protocol.</workbench-requirement>
/// </workbench-requirements>
[Requirement("REQ-QUIC-RFC9000-S11P2-0003")]
public sealed class REQ_QUIC_RFC9000_S11P2_0003
{
    ...
    public async Task AbortRead_UsesTheApplicationProtocolDirectApiPath()
    {
