...
///   <workbench-requirement requirementId="REQ-QUIC-RFC9000-S22P1P4-0003">The creation of a registry MAY specify additional constraints on permanent registrations.</workbench-requirement>
/// </workbench-requirements>
[Requirement("REQ-QUIC-RFC9000-S22P1P4-0003")]
public sealed class REQ_QUIC_RFC9000_S22P1P4_0003
{
    [Fact]
    [CoverageType(RequirementCoverageType.Positive)]
    [Trait("Category", "Positive")]
    public void RequirementStatement_AllowsAdditionalConstraintsForPermanentRegistrations()
    {
