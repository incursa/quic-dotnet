...
///   <workbench-requirement requirementId="REQ-QUIC-RFC9000-1033">A server MAY send Retry packets in response to Initial and 0-RTT packets.</workbench-requirement>
/// </workbench-requirements>
[Requirement("REQ-QUIC-RFC9000-1033")]
public sealed class REQ_QUIC_RFC9000_1033
{
    [Fact]
    ...
    public async Task ListenerHostCanOmitRetryPacketsForInitialDatagramsWhenRetryBootstrapIsDisabled()
    {
        ...
        Assert.False(listenerHost.RetryBootstrapIssued);
    }
