...
///   <workbench-requirement requirementId="REQ-QUIC-RFC9000-S8P1P4-0003">When tokens are used in Retry packets, the server SHOULD include information that allows the server to verify that the source IP address and port in client packets remain constant.</workbench-requirement>
/// </workbench-requirements>
[Requirement("REQ-QUIC-RFC9000-S8P1P4-0003")]
[Collection(QuicLoopbackNetworkTestCollection.Name)]
public sealed class REQ_QUIC_RFC9000_S8P1P4_0003
{
    [Fact]
    [Requirement("REQ-QUIC-RFC9000-S8P1P4-0003")]
