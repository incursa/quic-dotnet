...
///   <workbench-requirement requirementId="REQ-QUIC-RFC9000-0610">Tokens MUST be invalidated when their associated connection ID is retired via a RETIRE_CONNECTION_ID frame.</workbench-requirement>
/// </workbench-requirements>
[Requirement("REQ-QUIC-RFC9000-0610")]
public sealed class REQ_QUIC_RFC9000_0610
{
    [Fact]
