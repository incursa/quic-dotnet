...
///   <workbench-requirement requirementId="RFC9000-S13-2-5-P2-S3-R01">Endpoints SHOULD include buffering delays caused by unavailability of decryption keys.</workbench-requirement>
