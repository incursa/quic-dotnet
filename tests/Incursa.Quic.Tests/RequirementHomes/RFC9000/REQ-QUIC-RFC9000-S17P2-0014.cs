...
///   <workbench-requirement requirementId="REQ-QUIC-RFC9000-S17P2-0014">The next bit (0x40) of byte 0 MUST be set to 1, unless the packet is a Version Negotiation packet.</workbench-requirement>
