...
public sealed class REQ_QUIC_RFC9000_S19P19_0001
{
    ...
    public void TryParseConnectionCloseFrame_DoesNotClassifyApplicationCloseAsTransportClose()
    {
        ...
        Assert.NotEqual((byte)0x1C, parsed.FrameType);
        Assert.Equal(encoded.Length, bytesConsumed);
    }
    ...
    [Trait("Category", "Edge")]
    public void TryParseConnectionCloseFrame_PreservesNoErrorTransportCloseWithoutReason()
    {
    ...
    ///   <workbench-requirement requirementId="REQ-QUIC-RFC9000-1358">A CONNECTION_CLOSE frame of type 0x1c MUST use codes from the space defined in Section 20.1.</workbench-requirement>
