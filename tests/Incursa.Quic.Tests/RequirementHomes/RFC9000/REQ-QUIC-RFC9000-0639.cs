...
///   <workbench-requirement requirementId="REQ-QUIC-RFC9000-0639">If the last 16 bytes of the datagram are identical in value to a stateless reset token, the endpoint MUST enter the draining period.</workbench-requirement>
/// </workbench-requirements>
[Requirement("REQ-QUIC-RFC9000-0639")]
public sealed class REQ_QUIC_RFC9000_0639
{
    [Fact]
