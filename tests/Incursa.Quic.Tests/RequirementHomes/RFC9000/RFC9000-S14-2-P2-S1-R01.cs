...
///   <workbench-requirement requirementId="RFC9000-S14-2-P2-S1-R01">An endpoint SHOULD use DPLPMTUD or PMTUD to determine whether the path to a destination will support a desired maximum datagram size without fragmentation.</workbench-requirement>
/// </workbench-requirements>
[Requirement("RFC9000-S14-2-P2-S1-R01")]
