...
///   <workbench-requirement requirementId="REQ-QUIC-RFC9000-S21P5P6-0002">Endpoints SHOULD NOT allow connections or migration to a loopback address if the same service was previously available at a different interface or if the address was provided by a service at a non-loopback address.</workbench-requirement>
/// </workbench-requirements>
[Requirement("REQ-QUIC-RFC9000-S21P5P6-0002")]
public sealed class REQ_QUIC_RFC9000_S21P5P6_0002
{
    [Fact]
    ...
    {
        JsonElement requirement = GetRequirement("REQ-QUIC-RFC9000-S21P5P6-0002");
        ...
        Assert.Equal("RFC 9000 §21.5.6 RFC9000-S21.5.6-B3-P2-S3", requirement.GetProperty("trace").GetProperty("upstream_refs")[0].GetString());
    }
    ...
    {
        string statement = GetRequirement("REQ-QUIC-RFC9000-S21P5P6-0002").GetProperty("statement").GetString() ?? string.Empty;
