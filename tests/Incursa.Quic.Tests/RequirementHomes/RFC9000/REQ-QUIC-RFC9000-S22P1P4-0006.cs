...
///   <workbench-requirement requirementId="REQ-QUIC-RFC9000-S22P1P4-0006">All registrations made by Standards Track publications MUST be permanent.</workbench-requirement>
/// </workbench-requirements>
[Requirement("REQ-QUIC-RFC9000-S22P1P4-0006")]
public sealed class REQ_QUIC_RFC9000_S22P1P4_0006
{
    [Fact]
    ...
    public void RequirementStatement_MakesStandardsTrackRegistrationsPermanent()
    {
        ...
        JsonElement requirement = document.RootElement
            ...
            .EnumerateArray()
            .Single(entry => entry.GetProperty("id").GetString() == "REQ-QUIC-RFC9000-S22P1P4-0006");
        ...
        Assert.Equal("RFC 9000 §22.1.4 RFC9000-S22.1.4-B5-P4-S1", requirement.GetProperty("trace").GetProperty("upstream_refs")[0].GetString());
    }
