...
///   <workbench-requirement requirementId="REQ-QUIC-RFC9000-0575">An endpoint in the closing state MUST send a packet containing a CONNECTION_CLOSE frame in response to any incoming packet that it attributes to the connection.</workbench-requirement>
/// </workbench-requirements>
[Requirement("REQ-QUIC-RFC9000-0575")]
public sealed class REQ_QUIC_RFC9000_0575
{
    [Fact]
