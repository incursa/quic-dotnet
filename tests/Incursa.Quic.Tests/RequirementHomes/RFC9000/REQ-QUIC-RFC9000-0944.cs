...
///   <workbench-requirement requirementId="REQ-QUIC-RFC9000-0944">The byte following the Destination Connection ID MUST contain the length in bytes of the Source Connection ID field that follows it.</workbench-requirement>
/// </workbench-requirements>
[Requirement("REQ-QUIC-RFC9000-0944")]
public sealed class REQ_QUIC_RFC9000_0944
{
    [Theory]
    [InlineData(0, 1)]
    [InlineData(3, 2)]
