...
///   <workbench-requirement requirementId="REQ-QUIC-RFC9000-S10P2P1-0003">An endpoint MAY retain packet protection keys for incoming packets to allow it to read and process a CONNECTION_CLOSE frame.</workbench-requirement>
/// </workbench-requirements>
[Requirement("REQ-QUIC-RFC9000-S10P2P1-0003")]
public sealed class REQ_QUIC_RFC9000_S10P2P1_0003
{
    [Fact]
