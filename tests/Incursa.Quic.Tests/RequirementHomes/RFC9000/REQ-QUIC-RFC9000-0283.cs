...
public sealed class REQ_QUIC_RFC9000_0283
{
    [Fact]
    ...
    ///   <workbench-requirement requirementId="REQ-QUIC-RFC9000-0283">A Version Negotiation packet MUST include a list of versions that the server will accept.</workbench-requirement>
    ...
    [Fact]
    /// <workbench-requirements generated="true" source="workbench quality sync">
    ///   <workbench-requirement requirementId="RFC9000-S5-2-2-P1-S1-R01">If a server receives a packet that indicates an unsupported version and the packet is large enough to initiate a new connection for any supported version, the server SHOULD send a Version Negotiation packet.</workbench-requirement>
    ...
    ///   <workbench-requirement requirementId="REQ-QUIC-RFC9000-0283">A Version Negotiation packet MUST include a list of versions that the server will accept.</workbench-requirement>
    /// </workbench-requirements>
    [Requirement("RFC9000-S5-2-2-P1-S1-R01")]
