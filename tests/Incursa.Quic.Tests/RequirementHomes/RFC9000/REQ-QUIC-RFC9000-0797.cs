...
///   <workbench-requirement requirementId="REQ-QUIC-RFC9000-0797">Connection close signals, including packets that contain CONNECTION_CLOSE frames, MUST NOT be sent again when packet loss is detected.</workbench-requirement>
/// </workbench-requirements>
[Requirement("REQ-QUIC-RFC9000-0797")]
public sealed class REQ_QUIC_RFC9000_0797
{
    [Fact]
    [Requirement("REQ-QUIC-RFC9000-0797")]
    [CoverageType(RequirementCoverageType.Positive)]
    [Trait("Category", "Positive")]
    public void LocalCloseRequested_EmitsConnectionCloseAndEntersClosing()
    {
