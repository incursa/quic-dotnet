...
public sealed class REQ_QUIC_RFC9000_S9P6P3_0005
{
    [Fact]
    [CoverageType(RequirementCoverageType.Positive)]
    [Trait("Category", "Positive")]
    public void ProbePacketsFromADifferentAddressTriggerPathValidationWithAChallenge()
    {
        ...
        byte[] preferredIpv4Address = [198, 51, 100, 31];
        byte[] preferredIpv6Address = [0x20, 0x01, 0x0D, 0xB8, 0x00, 0x01, 0x00, 0x02, 0x00, 0x03, 0x00, 0x04, 0x00, 0x05, 0x00, 0x1F];
        ...
        QuicConnectionPathIdentity activePath = new("203.0.113.31", RemotePort: 443);
        QuicConnectionPathIdentity preferredPath = new("198.51.100.31", RemotePort: 9444);
