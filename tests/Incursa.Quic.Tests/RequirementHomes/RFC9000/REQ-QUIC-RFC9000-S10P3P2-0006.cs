...
///   <workbench-requirement requirementId="REQ-QUIC-RFC9000-S10P3P2-0006">A connection ID from a connection that is reset by revealing the stateless reset token MUST NOT be reused for new connections at nodes that share a static key.</workbench-requirement>
/// </workbench-requirements>
[Requirement("REQ-QUIC-RFC9000-S10P3P2-0006")]
public sealed class REQ_QUIC_RFC9000_S10P3P2_0006
{
    [Fact]
