...
///   <workbench-requirement requirementId="REQ-QUIC-RFC9000-0709">A QUIC endpoint MUST NOT reuse a packet number within the same packet number space in one connection.</workbench-requirement>
/// </workbench-requirements>
[Requirement("REQ-QUIC-RFC9000-0709")]
public sealed class REQ_QUIC_RFC9000_0709
{
    [Fact]
