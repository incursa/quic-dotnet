...
///   <workbench-requirement requirementId="REQ-QUIC-RFC9000-0985">A client that receives an Initial packet with a non-zero Token Length field MUST either discard the packet or generate a connection error of type PROTOCOL_VIOLATION.</workbench-requirement>
/// </workbench-requirements>
[Requirement("REQ-QUIC-RFC9000-0985")]
public sealed class REQ_QUIC_RFC9000_0985
{
