...
///   <workbench-requirement requirementId="RFC9000-S10-2-1-P2-S2-R01">An endpoint in the closing state MUST send a packet containing a CONNECTION_CLOSE frame in response to any incoming packet that it attributes to the connection.</workbench-requirement>
/// </workbench-requirements>
[Requirement("RFC9000-S10-2-1-P2-S2-R01")]
public sealed class RFC9000_S10_2_1_P2_S2_R01
{
    [Fact]
