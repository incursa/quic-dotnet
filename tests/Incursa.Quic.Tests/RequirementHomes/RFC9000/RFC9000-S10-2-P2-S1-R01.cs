...
///   <workbench-requirement requirementId="RFC9000-S10-2-P2-S1-R01">After sending a CONNECTION_CLOSE frame, an endpoint MUST immediately enter the closing state.</workbench-requirement>
/// </workbench-requirements>
[Requirement("RFC9000-S10-2-P2-S1-R01")]
public sealed class RFC9000_S10_2_P2_S1_R01
{
    [Fact]
