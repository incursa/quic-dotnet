...
///   <workbench-requirement requirementId="REQ-QUIC-RFC9000-S12P4-0012">An endpoint MUST treat receipt of a frame in a packet type that is not permitted as a connection error of type PROTOCOL_VIOLATION.</workbench-requirement>
/// </workbench-requirements>
[Requirement("REQ-QUIC-RFC9000-S12P4-0012")]
public sealed class REQ_QUIC_RFC9000_S12P4_0012
{
    [Fact]
