...
///   <workbench-requirement requirementId="REQ-QUIC-RFC9000-0019">QUIC streams MUST provide an ordered byte-stream abstraction to an application.</workbench-requirement>
/// </workbench-requirements>
[Requirement("REQ-QUIC-RFC9000-0019")]
[Collection(QuicLoopbackNetworkTestCollection.Name)]
public sealed class REQ_QUIC_RFC9000_0019
{
    [Fact]
    [Requirement("REQ-QUIC-RFC9000-0019")]
