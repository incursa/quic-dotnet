...
///   <workbench-requirement requirementId="RFC9000-S17-2-5-2-P3-R01">The client responds to a Retry packet with an Initial packet that MUST include the provided Retry token to continue connection establishment.</workbench-requirement>
/// </workbench-requirements>
[Requirement("RFC9000-S17-2-5-2-P3-R01")]
public sealed class RFC9000_S17_2_5_2_P3_R01
{
    [Fact]
