...
///   <workbench-requirement requirementId="REQ-QUIC-RFC9000-0219">The initial connection ID issued by an endpoint MUST be sent in the Source Connection ID field of the long packet header during the handshake.</workbench-requirement>
/// </workbench-requirements>
[Requirement("REQ-QUIC-RFC9000-0219")]
public sealed class REQ_QUIC_RFC9000_0219
{
    [Fact]
