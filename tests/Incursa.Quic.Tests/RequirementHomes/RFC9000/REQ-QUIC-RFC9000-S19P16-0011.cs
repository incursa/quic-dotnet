...
[Requirement("REQ-QUIC-RFC9000-S19P16-0011")]
public sealed class REQ_QUIC_RFC9000_S19P16_0011
{
    [Fact]
    /// <workbench-requirements generated="true" source="manual">
    ///   <workbench-requirement requirementId="REQ-QUIC-RFC9000-S19P16-0011">An endpoint that provides a zero-length connection ID MUST treat receipt of a RETIRE_CONNECTION_ID frame as a connection error of type PROTOCOL_VIOLATION.</workbench-requirement>
