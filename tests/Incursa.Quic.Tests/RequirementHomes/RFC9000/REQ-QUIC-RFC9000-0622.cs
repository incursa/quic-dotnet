...
///   <workbench-requirement requirementId="REQ-QUIC-RFC9000-0622">An endpoint MUST NOT send a Stateless Reset that is three times or more larger than the packet it receives.</workbench-requirement>
/// </workbench-requirements>
[Requirement("REQ-QUIC-RFC9000-0622")]
public sealed class REQ_QUIC_RFC9000_0622
{
    [Theory]
    [InlineData(100, 99)]
    [InlineData(100, 250)]
