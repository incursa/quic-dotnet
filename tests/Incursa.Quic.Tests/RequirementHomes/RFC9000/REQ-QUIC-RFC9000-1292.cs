...
///   <workbench-requirement requirementId="REQ-QUIC-RFC9000-1292">An endpoint MUST terminate a connection with an error of type STREAM_LIMIT_ERROR if a peer opens more streams than was permitted.</workbench-requirement>
/// </workbench-requirements>
[Requirement("REQ-QUIC-RFC9000-1292")]
public sealed class REQ_QUIC_RFC9000_1292
{
    [Fact]
