...
///   <workbench-requirement requirementId="REQ-QUIC-RFC9000-0905">The QUIC variable-length integer encoding MUST reserve the two most significant bits of the first byte to encode the base-2 logarithm of the integer encoding length in bytes.</workbench-requirement>
/// </workbench-requirements>
[Requirement("REQ-QUIC-RFC9000-0905")]
public sealed class REQ_QUIC_RFC9000_0905
{
