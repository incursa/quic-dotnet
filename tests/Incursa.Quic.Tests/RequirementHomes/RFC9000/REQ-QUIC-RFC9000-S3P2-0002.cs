...
///   <workbench-requirement requirementId="REQ-QUIC-RFC9000-S3P2-0002">The receiving part of a stream MUST track the delivery of data to the application, including data that cannot be observed by the sender.</workbench-requirement>
/// </workbench-requirements>
[Requirement("REQ-QUIC-RFC9000-S3P2-0002")]
public sealed class REQ_QUIC_RFC9000_S3P2_0002
{
    [Fact]
    [Requirement("REQ-QUIC-RFC9000-S3P2-0002")]
    [CoverageType(RequirementCoverageType.Positive)]
    [Trait("Category", "Positive")]
    public void TryReadStreamData_TracksDeliveryOfBufferedPeerData()
    {
