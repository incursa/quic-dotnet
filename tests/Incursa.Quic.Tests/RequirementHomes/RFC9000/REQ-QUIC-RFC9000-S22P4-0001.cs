...
///   <workbench-requirement requirementId="REQ-QUIC-RFC9000-S22P4-0001">Permanent registrations in this registry MUST be assigned using the Specification Required policy.</workbench-requirement>
/// </workbench-requirements>
[Requirement("REQ-QUIC-RFC9000-S22P4-0001")]
public sealed class REQ_QUIC_RFC9000_S22P4_0001
{
    [Fact]
    [CoverageType(RequirementCoverageType.Positive)]
    [Trait("Category", "Positive")]
    public void RequirementStatement_UsesSpecificationRequiredPolicyForFrameTypes()
    {
