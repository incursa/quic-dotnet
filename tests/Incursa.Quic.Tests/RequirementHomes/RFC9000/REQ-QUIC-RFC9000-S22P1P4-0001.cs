...
///   <workbench-requirement requirementId="REQ-QUIC-RFC9000-S22P1P4-0001">Permanent registrations in QUIC registries MUST use the Specification Required policy (Section 4.6 of [RFC8126]), unless otherwise specified.</workbench-requirement>
/// </workbench-requirements>
[Requirement("REQ-QUIC-RFC9000-S22P1P4-0001")]
public sealed class REQ_QUIC_RFC9000_S22P1P4_0001
{
    [Fact]
    [CoverageType(RequirementCoverageType.Positive)]
    [Trait("Category", "Positive")]
    public void RequirementStatement_UsesSpecificationRequiredPolicyForPermanentRegistrations()
    {
