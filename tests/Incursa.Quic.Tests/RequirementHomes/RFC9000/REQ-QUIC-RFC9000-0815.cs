...
///   <workbench-requirement requirementId="REQ-QUIC-RFC9000-0815">Responses to path validation using PATH_RESPONSE frames MUST be sent just once.</workbench-requirement>
...
public sealed class REQ_QUIC_RFC9000_0815
{
