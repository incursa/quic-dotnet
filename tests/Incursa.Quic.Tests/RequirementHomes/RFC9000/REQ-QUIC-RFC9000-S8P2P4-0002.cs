...
[Requirement("REQ-QUIC-RFC9000-S8P2P4-0002")]
public sealed class REQ_QUIC_RFC9000_S8P2P4_0002
{
    [Fact]
    [CoverageType(RequirementCoverageType.Positive)]
    [Trait("Category", "Positive")]
    public void NoViablePathIsSignaledWhenNoValidatedPathRemains()
    {
        (QuicConnectionRuntime runtime, _, QuicConnectionPathIdentity candidatePath) =
            QuicS8P2P4NoViablePathTestSupport.CreateRuntimeWithCandidatePath(
                activeAddress: "203.0.113.30",
                candidateAddress: "203.0.113.31",
        ...
        Assert.DoesNotContain(failureResult.Effects, effect => effect is QuicConnectionSendDatagramEffect);
    }

    [Fact]
    [CoverageType(RequirementCoverageType.Negative)]
    [Trait("Category", "Negative")]
    public void NoViablePathIsNotSignaledWhenAValidatedPathRemains()
    {
