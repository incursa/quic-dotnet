...
///   <workbench-requirement requirementId="REQ-QUIC-RFC9000-0548">An endpoint MAY discard connection state if it does not have a validated path on which it can send packets.</workbench-requirement>
/// </workbench-requirements>
[Requirement("REQ-QUIC-RFC9000-0548")]
public sealed class REQ_QUIC_RFC9000_0548
{
    [Fact]
