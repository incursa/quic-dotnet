...
///   <workbench-requirement requirementId="REQ-QUIC-RFC9000-S22P1P4-0002">The designated expert or experts MUST verify that a specification exists and is readily accessible.</workbench-requirement>
/// </workbench-requirements>
[Requirement("REQ-QUIC-RFC9000-S22P1P4-0002")]
public sealed class REQ_QUIC_RFC9000_S22P1P4_0002
{
    [Fact]
    [CoverageType(RequirementCoverageType.Positive)]
    [Trait("Category", "Positive")]
    public void RequirementStatement_RequiresAccessibleSpecificationForPermanentRegistrations()
    {
