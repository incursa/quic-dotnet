...
public sealed class REQ_QUIC_RFC9000_0245
{
    [Fact]
    /// <workbench-requirements generated="true" source="manual">
    ///   <workbench-requirement requirementId="REQ-QUIC-RFC9000-0245">Endpoints SHOULD retire connection IDs when they are no longer actively using either the local or destination address for which the connection ID was used.</workbench-requirement>
    ...
    public async Task SameAddressPairConnectionIdRotationDoesNotRetireTheEarlierPeerConnectionId()
    {
        ...
        await REQ_QUIC_RFC9000_0244.BindPeerConnectionIdToCurrentPath(runtime, firstConnectionIdForSamePair);
        _ = REQ_QUIC_RFC9000_0244.AddMigratedPathConnectionId(runtime, secondConnectionIdForSamePair);
