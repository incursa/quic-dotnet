...
///   <workbench-requirement requirementId="REQ-QUIC-RFC9000-S10P3P2-0007">The same stateless reset token MUST NOT be used for multiple connection IDs.</workbench-requirement>
/// </workbench-requirements>
[Requirement("REQ-QUIC-RFC9000-S10P3P2-0007")]
public sealed class REQ_QUIC_RFC9000_S10P3P2_0007
{
    [Fact]
