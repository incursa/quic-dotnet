...
///   <workbench-requirement requirementId="REQ-QUIC-RFC9000-S22P4-0002">Values between 0x00 and 0x3f inclusive MUST be assigned using Standards Action or IESG Approval.</workbench-requirement>
/// </workbench-requirements>
[Requirement("REQ-QUIC-RFC9000-S22P4-0002")]
public sealed class REQ_QUIC_RFC9000_S22P4_0002
{
    [Fact]
    [CoverageType(RequirementCoverageType.Positive)]
    [Trait("Category", "Positive")]
    public void RequirementStatement_UsesStricterPolicyForLowFrameTypeCodepoints()
    {
        ...
        JsonElement requirement = document.RootElement
            ...
            .EnumerateArray()
            .Single(entry => entry.GetProperty("id").GetString() == "REQ-QUIC-RFC9000-S22P4-0002");

        Assert.Equal("Use stricter policy for low frame-type codepoints", requirement.GetProperty("title").GetString());
