...
///   <workbench-requirement requirementId="REQ-QUIC-RFC9000-S10P2P1-0007">An endpoint in the closing state MUST either discard packets received from an unvalidated address or limit the cumulative size of packets it sends to an unvalidated address to three times the size of packets it receives from that address.</workbench-requirement>
/// </workbench-requirements>
[Requirement("REQ-QUIC-RFC9000-S10P2P1-0007")]
public sealed class REQ_QUIC_RFC9000_S10P2P1_0007
{
    [Fact]
