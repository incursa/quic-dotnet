...
public sealed class REQ_QUIC_INT_0031
{
    ...
    public void ExternalHttp3HarnessDefinesRequestedTargetsAndScenarios()
    {
        ...
        Assert.Contains("http3-summary.json", windowsScript, StringComparison.Ordinal);
        Assert.Contains("stdout.log", windowsScript, StringComparison.Ordinal);
        Assert.Contains("stderr.log", windowsScript, StringComparison.Ordinal);
        ...
        Assert.Contains("http3-summary.json", posixScript, StringComparison.Ordinal);
        Assert.Contains("stdout.log", posixScript, StringComparison.Ordinal);
        Assert.Contains("stderr.log", posixScript, StringComparison.Ordinal);
