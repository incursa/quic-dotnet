...
public sealed class REQ_QUIC_INT_0022
{
    ...
    public void ConnectionMigrationServerProofProfileAddsDedicatedHostedCorroborationLane()
    {
        ...
        Assert.Contains("picoquic`, `lsquic`, `neqo`, `quiche`, `quic-go`, `msquic`, and `aioquic", readme, StringComparison.Ordinal);
        ...
        Assert.Contains("picoquic`, `lsquic`, `neqo`, `quiche`, `quic-go`, `msquic`, and `aioquic", harnessReadme, StringComparison.Ordinal);
        ...
        Assert.Contains("`lsquic`, `neqo`, `quiche`, `quic-go`, `msquic`, and `aioquic`", currentStatus, StringComparison.Ordinal);
        ...
        Assert.Contains("picoquic`, `lsquic`, `neqo`, `quiche`, `quic-go`, `msquic`, and `aioquic", spec, StringComparison.Ordinal);
    }
