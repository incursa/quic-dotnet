...
public sealed class REQ_QUIC_INT_0022
{
    ...
    public void ConnectionMigrationServerProofProfileAddsDedicatedHostedCorroborationLane()
    {
        ...
        Assert.Contains("implementation_slot: picoquic", workflow, StringComparison.Ordinal);
        Assert.Contains("peer_slots: quinn", workflow, StringComparison.Ordinal);
        Assert.Contains("stammw/quinn-interop:latest", workflow, StringComparison.Ordinal);
        ...
        Assert.Contains("against `quinn`", readme, StringComparison.Ordinal);
        Assert.Contains("using the `picoquic` slot", readme, StringComparison.Ordinal);
        ...
        Assert.Contains("against `quinn`", harnessReadme, StringComparison.Ordinal);
        Assert.Contains("using the `picoquic` slot", harnessReadme, StringComparison.Ordinal);
        ...
        Assert.Contains("against `quinn`", currentStatus, StringComparison.Ordinal);
        Assert.Contains("using the `picoquic` slot", currentStatus, StringComparison.Ordinal);
        ...
        Assert.Contains("against `quinn`", spec, StringComparison.Ordinal);
        Assert.Contains("using the `picoquic` slot", spec, StringComparison.Ordinal);
