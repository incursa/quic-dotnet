...
public sealed class REQ_QUIC_INT_0022
{
    ...
    public void ConnectionMigrationServerProofProfileAddsDedicatedHostedCorroborationLane()
    {
        ...
        Assert.Contains("lsquic`, `quiche`, `quic-go`, `msquic`, `neqo`, and `aioquic", readme, StringComparison.Ordinal);
        ...
        Assert.Contains("lsquic`, `quiche`, `quic-go`, `msquic`, `neqo`, and `aioquic", harnessReadme, StringComparison.Ordinal);
        ...
        Assert.Contains("lsquic`, `quiche`, `quic-go`, `msquic`, `neqo`, and `aioquic", currentStatus, StringComparison.Ordinal);
        ...
        Assert.Contains("lsquic`, `quiche`, `quic-go`, `msquic`, `neqo`, and `aioquic", spec, StringComparison.Ordinal);
    }
