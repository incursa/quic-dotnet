...
public sealed class REQ_QUIC_INT_0022
{
    ...
    public void ConnectionMigrationServerProofProfileAddsDedicatedHostedCorroborationLane()
    {
        ...
        Assert.Contains("server-connectionmigration-neqo-xquic", workflow, StringComparison.Ordinal);
        Assert.Contains("ghcr.io/alibaba/xquic/xquic-interop:latest", workflow, StringComparison.Ordinal);
        ...
        Assert.Contains("against `neqo` with `xquic`", readme, StringComparison.Ordinal);
        Assert.Contains("picoquic`, `ngtcp2`, `neqo`, `lsquic`, `quiche`, `quic-go`, `msquic`, and `aioquic", readme, StringComparison.Ordinal);
        ...
        Assert.Contains("against `neqo` with `xquic`", harnessReadme, StringComparison.Ordinal);
        Assert.Contains("picoquic`, `ngtcp2`, `neqo`, `lsquic`, `quiche`, `quic-go`, `msquic`, and `aioquic", harnessReadme, StringComparison.Ordinal);
        ...
        Assert.Contains("against `neqo` with `xquic`", currentStatus, StringComparison.Ordinal);
        Assert.Contains("preserves `picoquic`,", currentStatus, StringComparison.Ordinal);
        Assert.Contains("`ngtcp2`, `neqo`, `lsquic`, `quiche`, `quic-go`, `msquic`, and `aioquic`", currentStatus, StringComparison.Ordinal);
        ...
        Assert.Contains("against `neqo` with `xquic`", spec, StringComparison.Ordinal);
        Assert.Contains("picoquic`, `ngtcp2`, `neqo`, `lsquic`, `quiche`, `quic-go`, `msquic`, and `aioquic", spec, StringComparison.Ordinal);
    }
