...
public sealed class REQ_QUIC_INT_0022
{
    ...
    public void ConnectionMigrationServerProofProfileAddsDedicatedHostedCorroborationLane()
    {
        ...
        Assert.DoesNotContain("server-connectionmigration-ngtcp2-lsquic", workflow, StringComparison.Ordinal);
        ...
        Assert.Contains("picoquic`, `quiche`, `lsquic`, `quic-go`, `msquic`, and `aioquic", readme, StringComparison.Ordinal);
        ...
        Assert.Contains("picoquic`, `quiche`, `lsquic`, `quic-go`, `msquic`, and `aioquic", harnessReadme, StringComparison.Ordinal);
        ...
        Assert.Contains("`quiche`, `lsquic`, `quic-go`,", currentStatus, StringComparison.Ordinal);
        ...
        Assert.Contains("picoquic`, `quiche`, `lsquic`, `quic-go`, `msquic`, and `aioquic", spec, StringComparison.Ordinal);
    }
