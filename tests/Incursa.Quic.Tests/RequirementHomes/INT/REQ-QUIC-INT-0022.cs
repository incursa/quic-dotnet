...
public sealed class REQ_QUIC_INT_0022
{
    ...
    public void ConnectionMigrationServerProofProfileAddsDedicatedHostedCorroborationLane()
    {
        ...
        Assert.Contains("peer_slots: lsquic", workflow, StringComparison.Ordinal);
        Assert.Contains("litespeedtech/lsquic-qir:latest", workflow, StringComparison.Ordinal);
        Assert.DoesNotContain("server-connectionmigration-ngtcp2-ngtcp2", workflow, StringComparison.Ordinal);
        Assert.DoesNotContain("server-connectionmigration-ngtcp2-picoquic", workflow, StringComparison.Ordinal);
        Assert.DoesNotContain("server-connectionmigration-ngtcp2-neqo", workflow, StringComparison.Ordinal);
        ...
        Assert.Contains("picoquic`, `quiche`, `ngtcp2`, `quic-go`, `msquic`, and `aioquic", readme, StringComparison.Ordinal);
        ...
        Assert.Contains("picoquic`, `quiche`, `ngtcp2`, `quic-go`, `msquic`, and `aioquic", harnessReadme, StringComparison.Ordinal);
        ...
        Assert.Contains("picoquic`, `quiche`, `ngtcp2`, `quic-go`, `msquic`, and `aioquic", spec, StringComparison.Ordinal);
    }
