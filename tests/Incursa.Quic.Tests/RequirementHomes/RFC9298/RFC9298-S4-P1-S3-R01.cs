...
public sealed class RFC9298_S4_P1_S3_R01
{
    [Fact]
    ...
    public void Rfc9298DatagramContextTraceArtifactsAreLinked()
    {
        ...
        Assert.Contains("RFC9298-S4-P1-S3-R01", architecture, StringComparison.Ordinal);
        Assert.Contains("REQ-QUIC-RFC9298-0095", architecture, StringComparison.Ordinal);
        Assert.Contains("RFC9298-S4-P1-S3-R01", workItem, StringComparison.Ordinal);
        Assert.Contains("REQ-QUIC-RFC9298-0095", workItem, StringComparison.Ordinal);
        Assert.Contains("RFC9298-S4-P1-S3-R01", verification, StringComparison.Ordinal);
