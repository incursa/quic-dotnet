...
public sealed class RFC9463_S3_1_1_P1_R01
{
    [Fact]
    ...
    public void Rfc9463EncryptedDnsDiscoveryTraceArtifactsAreLinked()
    {
        ...
        Assert.Contains("RFC9463-S3-1-1-P1-R01", architecture, StringComparison.Ordinal);
        Assert.Contains("REQ-QUIC-RFC9463-0116", architecture, StringComparison.Ordinal);
        Assert.Contains("RFC9463-S3-1-1-P1-R01", workItem, StringComparison.Ordinal);
        Assert.Contains("REQ-QUIC-RFC9463-0116", workItem, StringComparison.Ordinal);
        Assert.Contains("RFC9463-S3-1-1-P1-R01", verification, StringComparison.Ordinal);
