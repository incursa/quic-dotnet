...
///   <workbench-requirement requirementId="RFC9002-S6-2-4-P6-R01">Instead of sending an ack-eliciting packet, the sender MAY mark any packets still in flight as lost.</workbench-requirement>
