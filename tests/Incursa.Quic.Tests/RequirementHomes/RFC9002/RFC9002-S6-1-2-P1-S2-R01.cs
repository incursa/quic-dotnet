...
///   <workbench-requirement requirementId="RFC9002-S6-1-2-P1-S2-R01">To avoid declaring packets lost too early, the time threshold MUST be at least the local timer granularity.</workbench-requirement>
