...
///   <workbench-requirement requirementId="RFC9002-S6-2-2-P2-S1-R01">A connection MAY use the delay between sending a PATH_CHALLENGE and receiving a PATH_RESPONSE to set the initial RTT for a new path.</workbench-requirement>
