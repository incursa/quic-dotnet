...
///   <workbench-requirement requirementId="RFC9002-S7-2-P2-S2-R01">If the maximum datagram size is decreased in order to complete the handshake, the congestion window SHOULD be set to the new initial congestion window.</workbench-requirement>
