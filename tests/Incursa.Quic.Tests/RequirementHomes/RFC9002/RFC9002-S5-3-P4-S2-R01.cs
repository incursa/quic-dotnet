...
///   <workbench-requirement requirementId="RFC9002-S5-3-P4-S2-R01">Before handshake confirmation, an endpoint MAY ignore an RTT sample if adjusting the sample for acknowledgment delay would make it smaller than min_rtt.</workbench-requirement>
