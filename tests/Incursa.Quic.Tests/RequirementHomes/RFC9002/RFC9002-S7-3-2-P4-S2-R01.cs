...
///   <workbench-requirement requirementId="RFC9002-S7-3-2-P4-S2-R01">During a recovery period, the congestion window MUST NOT change in response to new losses or increases in the ECN-CE count.</workbench-requirement>
/// </workbench-requirements>
[Requirement("RFC9002-S7-3-2-P4-S2-R01")]
public sealed class RFC9002_S7_3_2_P4_S2_R01
{
    [Fact]
