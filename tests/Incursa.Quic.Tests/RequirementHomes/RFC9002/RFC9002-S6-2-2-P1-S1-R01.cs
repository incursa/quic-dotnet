...
///   <workbench-requirement requirementId="RFC9002-S6-2-2-P1-S1-R01">Resumed connections over the same network MAY use the previous connection&apos;s final smoothed RTT value as the resumed connection&apos;s initial RTT.</workbench-requirement>
