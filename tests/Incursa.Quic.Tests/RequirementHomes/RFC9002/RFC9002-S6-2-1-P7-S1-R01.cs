...
///   <workbench-requirement requirementId="RFC9002-S6-2-1-P7-S1-R01">An endpoint MUST NOT set its PTO timer for the Application Data packet number space until the handshake is confirmed.</workbench-requirement>
/// </workbench-requirements>
[Requirement("RFC9002-S6-2-1-P7-S1-R01")]
public sealed class RFC9002_S6_2_1_P7_S1_R01
{
