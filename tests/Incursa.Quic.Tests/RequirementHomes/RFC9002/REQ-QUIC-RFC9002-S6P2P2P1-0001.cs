...
///   <workbench-requirement requirementId="RFC9002-S6-2-2-1-P1-S2-R01">If no additional data can be sent, the server&apos;s PTO timer MUST NOT be armed until datagrams have been received from the client.</workbench-requirement>
