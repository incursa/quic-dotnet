...
///   <workbench-requirement requirementId="REQ-QUIC-RFC9002-SAP1-0003">Implementations MUST store the per-packet fields needed for loss recovery and congestion control.</workbench-requirement>
