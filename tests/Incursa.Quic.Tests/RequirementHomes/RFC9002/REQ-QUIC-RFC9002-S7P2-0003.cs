...
///   <workbench-requirement requirementId="RFC9002-S7-2-P2-S1-R01">If the maximum datagram size changes during the connection, the initial congestion window SHOULD be recalculated with the new size.</workbench-requirement>
