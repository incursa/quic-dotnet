...
///   <workbench-requirement requirementId="RFC9002-S6-3-P2-S2-R01">Clients MUST retain other connection state, in particular cryptographic handshake messages.</workbench-requirement>
/// </workbench-requirements>
[Requirement("RFC9002-S6-3-P2-S2-R01")]
public sealed class RFC9002_S6_3_P2_S2_R01
{
    [Fact]
