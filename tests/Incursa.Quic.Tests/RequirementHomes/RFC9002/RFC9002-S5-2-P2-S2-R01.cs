...
///   <workbench-requirement requirementId="RFC9002-S5-2-P2-S2-R01">On all RTT samples after the first, min_rtt MUST be set to the lesser of min_rtt and latest_rtt.</workbench-requirement>
