...
///   <workbench-requirement requirementId="RFC9002-S6-3-P3-S1-R01">The client MAY compute an RTT estimate to the server as the time period from when the first Initial packet was sent to when a Retry or Version Negotiation packet is received.</workbench-requirement>
