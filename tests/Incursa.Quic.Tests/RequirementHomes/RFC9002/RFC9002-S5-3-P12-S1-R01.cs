...
///   <workbench-requirement requirementId="RFC9002-S5-3-P12-S1-R01">`smoothed_rtt` is initialized to `kInitialRtt`.</workbench-requirement>
...
public sealed class RFC9002_S5_3_P12_S1_R01
{
    [Fact]
