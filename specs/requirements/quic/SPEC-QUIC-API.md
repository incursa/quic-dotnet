...
- A fuller public stream-transfer comparison remains deferred until the repo has a separately traced and proven public request/response workload that both stacks can execute honestly.
