...
- Only the first-successor old-key receive-selection and packet-number ordering floor is implemented; broader old/current/next epoch selection remains unimplemented until the lifecycle ledger exists.
