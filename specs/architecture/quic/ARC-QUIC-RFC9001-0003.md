...
- The next planned slice is the remaining AEAD-policy subset (`REQ-QUIC-RFC9001-S6P6-0003` through `REQ-QUIC-RFC9001-S6P6-0005`); repeated epoch selection beyond the first successor remains blocked until that control state exists.
