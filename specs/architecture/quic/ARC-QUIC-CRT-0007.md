...
Describe the narrow main-library handshake-flow seam that opens inbound Handshake packets, feeds CRYPTO bytes into the bridge driver, advances incremental transcript progress behind that bridge, drains outbound CRYPTO bytes back into protected Handshake packets, and returns send effects to the connection runtime.
