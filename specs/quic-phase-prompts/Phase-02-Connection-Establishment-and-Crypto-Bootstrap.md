...
Read first:
- the relevant QUIC spec file under ./specs/requirements/quic/
- if present: ./specs/generated/quic/chunks/9000-04-connection-ids-basics.reconciliation.md
- if present: ./specs/generated/quic/chunks/9000-04-connection-ids-basics.reconciliation.json
...
Read first:
- the relevant QUIC spec file under ./specs/requirements/quic/
- if present: ./specs/generated/quic/chunks/9000-05-connection-id-management.reconciliation.md
- if present: ./specs/generated/quic/chunks/9000-05-connection-id-management.reconciliation.json
- the repository’s existing conventions for tests, requirement attributes, and direct requirement refs
...
Read first:
- the relevant QUIC spec file under ./specs/requirements/quic/
- if present: ./specs/generated/quic/chunks/9000-06-version-negotiation.reconciliation.md
- if present: ./specs/generated/quic/chunks/9000-06-version-negotiation.reconciliation.json
- the repository’s existing conventions for tests, requirement attributes, and direct requirement refs
...
Read first:
- the relevant QUIC spec file under ./specs/requirements/quic/
- if present: ./specs/generated/quic/chunks/9001-01-tls-core.reconciliation.md
- if present: ./specs/generated/quic/chunks/9001-01-tls-core.reconciliation.json
- the repository’s existing conventions for tests, requirement attributes, and direct requirement refs
...
Read first:
- the relevant QUIC spec file under ./specs/requirements/quic/
- if present: ./specs/generated/quic/chunks/9000-07-handshake-properties.reconciliation.md
- if present: ./specs/generated/quic/chunks/9000-07-handshake-properties.reconciliation.json
- the repository’s existing conventions for tests, requirement attributes, and direct requirement refs
...
Read first:
- the relevant QUIC spec file under ./specs/requirements/quic/
- if present: ./specs/generated/quic/chunks/9000-08-transport-params-and-crypto-buffers.reconciliation.md
- if present: ./specs/generated/quic/chunks/9000-08-transport-params-and-crypto-buffers.reconciliation.json
- the repository’s existing conventions for tests, requirement attributes, and direct requirement refs
...
Read first:
- the relevant QUIC spec file under ./specs/requirements/quic/
- if present: ./specs/generated/quic/chunks/9000-09-address-validation-and-tokens.reconciliation.md
- if present: ./specs/generated/quic/chunks/9000-09-address-validation-and-tokens.reconciliation.json
- the repository’s existing conventions for tests, requirement attributes, and direct requirement refs
...
Read first:
- the relevant QUIC spec file under ./specs/requirements/quic/
- if present: ./specs/generated/quic/chunks/9000-10-path-validation.reconciliation.md
- if present: ./specs/generated/quic/chunks/9000-10-path-validation.reconciliation.json
- the repository’s existing conventions for tests, requirement attributes, and direct requirement refs
