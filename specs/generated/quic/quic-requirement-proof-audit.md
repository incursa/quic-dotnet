...
| Proof state | Count |
| --- | ---: |
| deferred_proof_not_executed | 1002 |
| full_executable_proof | 1675 |
...
| `REQ-QUIC-RFC9002-S3-0001` | RFC9002 | deferred_proof_not_executed |  | fuzz |
| `REQ-QUIC-RFC9002-S3-0008` | RFC9002 | deferred_proof_not_executed |  | fuzz |
