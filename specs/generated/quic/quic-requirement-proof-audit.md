...
| Proof state | Count |
| --- | ---: |
| deferred_proof_not_executed | 1362 |
| full_executable_proof | 1315 |
...
| `REQ-QUIC-RFC9000-S9P2-0004` | RFC9000 | deferred_proof_not_executed |  | fuzz |
