...
- RFC 9000 [`SPEC-QUIC-RFC9000.json`](../../requirements/quic/SPEC-QUIC-RFC9000.json) now carries the atomic `RFC9000-S8-P2-S2-R01`, with `RFC9000-S8-1-P4-R01` preserving the section-scoped restatement from RFC 9000 Section 8.1.
