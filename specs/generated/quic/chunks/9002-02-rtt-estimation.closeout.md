...
- `REQ-QUIC-RFC9002-S5P2-0005` - implemented and tested. Evidence: `src/Incursa.Quic/QuicRttEstimator.cs`, `tests/Incursa.Quic.Tests/QuicRttEstimatorTests.cs::RefreshMinRttFromLatestSample_AllowsExplicitMinRttReestablishment`.
- `REQ-QUIC-RFC9002-S5P2-0006` - implemented and tested. Evidence: `src/Incursa.Quic/QuicRttEstimator.cs`, `tests/Incursa.Quic.Tests/QuicRttEstimatorTests.cs::RefreshMinRttFromLatestSample_AllowsExplicitMinRttReestablishment`.
