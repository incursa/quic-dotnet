...
These depend on packet assembly, send-path batching, recovery timers, peer-ACK handling, decryption timing, or carrier-selection surfaces that are not present yet.
