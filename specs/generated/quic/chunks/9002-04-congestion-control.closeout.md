...
- `RFC9002-S7-P7-S1-R01` - Respect the bytes-in-flight ceiling. Status: implemented and tested. Evidence: src/Incursa.Quic/QuicCongestionControlState.cs, src/Incursa.Quic/PublicAPI.Unshipped.txt; tests: CanSendAndRegisterPacketSent_TreatAckOnlyPacketsAsFreeButCountProbesAsFlight.
...
- `RFC9002-S7-3-2-P2-S1-R01` - Cut the slow start threshold on recovery entry. Status: implemented and tested. Evidence: src/Incursa.Quic/QuicCongestionControlState.cs, src/Incursa.Quic/PublicAPI.Unshipped.txt; tests: TryRegisterLossAndProcessEcn_EnterRecoveryOnlyForEligibleSignals.
- `RFC9002-S7-3-2-P2-S2-R01` - Restore congestion window before leaving recovery. Status: implemented and tested. Evidence: src/Incursa.Quic/QuicCongestionControlState.cs, src/Incursa.Quic/PublicAPI.Unshipped.txt; tests: TryRegisterLossAndProcessEcn_EnterRecoveryOnlyForEligibleSignals.
- `RFC9002-S7-3-2-P3-S1-R01` - Permit gentler recovery-window reduction. Status: implemented and tested. Evidence: src/Incursa.Quic/QuicCongestionControlState.cs, src/Incursa.Quic/PublicAPI.Unshipped.txt; tests: TryRegisterLossAndProcessEcn_EnterRecoveryOnlyForEligibleSignals.
...
- `RFC9002-S7-3-3-P2-S1-R01` - Limit congestion-avoidance growth to one datagram per acknowledged window. Status: implemented and tested. Evidence: src/Incursa.Quic/QuicCongestionControlState.cs, src/Incursa.Quic/PublicAPI.Unshipped.txt; tests: TryRegisterLossAndProcessEcn_EnterRecoveryOnlyForEligibleSignals.

### S7P4
- `RFC9002-S7-4-P1-S3-R01` - Ignore undecryptable packet loss before keys are available. Status: implemented and tested. Evidence: src/Incursa.Quic/QuicCongestionControlState.cs, src/Incursa.Quic/PublicAPI.Unshipped.txt; tests: TryRegisterLossAndProcessEcn_EnterRecoveryOnlyForEligibleSignals.
- `RFC9002-S7-4-P1-S4-R01` - Do not ignore later packet loss. Status: implemented and tested. Evidence: src/Incursa.Quic/QuicCongestionControlState.cs, src/Incursa.Quic/PublicAPI.Unshipped.txt; tests: TryRegisterLossAndProcessEcn_EnterRecoveryOnlyForEligibleSignals.
