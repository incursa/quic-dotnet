...
- `REQ-QUIC-RFC9002-S7P2-0002` - Recommend the initial congestion window. Status: implemented and tested. Evidence: src/Incursa.Quic/QuicCongestionControlState.cs, src/Incursa.Quic/PublicAPI.Unshipped.txt; tests: Constructor_SeedsTheControllerWithTheInitialWindowAndKeepsInstancesIndependent.
...
- `REQ-QUIC-RFC9002-S7P6P2-0002` - Require the two declared-lost packets to be ack-eliciting. Status: implemented and tested. Evidence: src/Incursa.Quic/QuicCongestionControlState.cs, src/Incursa.Quic/PublicAPI.Unshipped.txt; tests: TryDetectPersistentCongestion_RequiresAckElicitingLossesAcrossTheWindow.
- `REQ-QUIC-RFC9002-S7P6P2-0003` - Delay persistent congestion until at least one RTT sample exists. Status: implemented and tested. Evidence: src/Incursa.Quic/QuicCongestionControlState.cs, src/Incursa.Quic/PublicAPI.Unshipped.txt; tests: TryDetectPersistentCongestion_RequiresAckElicitingLossesAcrossTheWindow.
- `REQ-QUIC-RFC9002-S7P6P2-0004` - Consider packet number spaces when declaring persistent congestion. Status: implemented and tested. Evidence: src/Incursa.Quic/QuicCongestionControlState.cs, src/Incursa.Quic/PublicAPI.Unshipped.txt; tests: TryDetectPersistentCongestion_RequiresAckElicitingLossesAcrossTheWindow.
- `REQ-QUIC-RFC9002-S7P6P2-0005` - Allow limited packet-number-space state when necessary. Status: implemented and tested. Evidence: src/Incursa.Quic/QuicCongestionControlState.cs, src/Incursa.Quic/PublicAPI.Unshipped.txt; tests: TryDetectPersistentCongestion_RequiresAckElicitingLossesAcrossTheWindow.
- `REQ-QUIC-RFC9002-S7P6P2-0006` - Reset cwnd to the minimum on persistent congestion. Status: implemented and tested. Evidence: src/Incursa.Quic/QuicCongestionControlState.cs, src/Incursa.Quic/PublicAPI.Unshipped.txt; tests: TryDetectPersistentCongestion_RequiresAckElicitingLossesAcrossTheWindow.
