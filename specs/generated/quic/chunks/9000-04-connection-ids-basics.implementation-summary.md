...
- `REQ-QUIC-RFC9000-0219`: blocked because the parser preserves source CID bytes, but there is no handshake sender or stateful connection logic proving initial-CID ownership.
