...
- `dotnet test tests/Incursa.Quic.Tests/Incursa.Quic.Tests.csproj --no-restore --filter "FullyQualifiedName~REQ_QUIC_RFC9000_S10P3_0010|FullyQualifiedName~REQ_QUIC_RFC9000_S10P3_0025|FullyQualifiedName~REQ_QUIC_RFC9000_S10P3_0028|FullyQualifiedName~REQ_QUIC_RFC9000_S10P3P1_0001|FullyQualifiedName~REQ_QUIC_RFC9000_S10P3P1_0008|FullyQualifiedName~REQ_QUIC_RFC9000_S10P3P1_0011|FullyQualifiedName~REQ_QUIC_RFC9000_S10P3P1_0012"`
  Result: passed, 18 tests passed, 0 failed, 0 skipped.
- `dotnet test tests/Incursa.Quic.Tests/Incursa.Quic.Tests.csproj --no-restore`
  Result: passed, 1359 tests passed, 0 failed, 0 skipped.
...
- The helper layer now closes the 38-bit visible-prefix floor, the three-times amplification ceiling, and the matched-reset drain/no-send lifecycle clauses without inventing endpoint orchestration.
- Remaining open items still need endpoint lifecycle policy: receive-path token memory scoped by remote address, token retirement invalidation, long-header reset policy, and stateful reset-send limiting.
