...
- This pass closed the ordered stream reassembly slice for `REQ-QUIC-RFC9000-S2P2-0002` and kept the remaining stream parser / frame codec refs aligned with the open clauses.
...
- `S2P2`: `REQ-QUIC-RFC9000-S2P2-0001`, `REQ-QUIC-RFC9000-S2P2-0002`

## Direct Trace Updates This Pass
- `REQ-QUIC-RFC9000-S2P2-0002` now has direct requirement-home proof in `tests/Incursa.Quic.Tests/RequirementHomes/RFC9000/REQ-QUIC-RFC9000-S2P2-0002.cs`, and `REQ-QUIC-RFC9000-S2P2-0009`, `REQ-QUIC-RFC9000-S2P4-0004`, `REQ-QUIC-RFC9000-S2P4-0005`, `REQ-QUIC-RFC9000-S2P4-0006`, and `REQ-QUIC-RFC9000-S2P4-0007` keep their direct refs on the existing parser/codec tests.
...
## Files Changed
- `tests/Incursa.Quic.Tests/RequirementHomes/RFC9000/REQ-QUIC-RFC9000-S2P2-0002.cs`
...
- `tests/Incursa.Quic.Tests/RequirementHomes/RFC9000/REQ-QUIC-RFC9000-S2P2-0002.cs`: added direct positive, negative, and edge proof for ordered stream reassembly.
...
- `S2P2`: `REQ-QUIC-RFC9000-S2P2-0003` through `REQ-QUIC-RFC9000-S2P2-0008` and `REQ-QUIC-RFC9000-S2P2-0010` remain not implemented; `REQ-QUIC-RFC9000-S2P2-0009` remains wire-level only.
