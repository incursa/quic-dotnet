...
- `REQ-QUIC-RFC9000-0572` and `RFC9000-S10-2-2-P3-S1-R01` remain helper-backed but blocked because the repo still lacks the endpoint runtime and CONNECTION_CLOSE receive/send pipeline needed to bind those transitions to real packets.
