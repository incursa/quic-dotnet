...
| --- | ---: |
| trace_clean | 630 |
| covered_but_missing_xrefs | 76 |
| covered_but_proof_too_broad | 175 |
| partially_covered | 320 |
| uncovered_blocked | 128 |
| uncovered_unblocked | 407 |
...
| new_tests_needed | 1018 |
| blocked | 128 |

## Queue

- Metadata-only fixes: 76 requirements. Examples: REQ-QUIC-RFC9000-S19P19-0012, REQ-QUIC-RFC9000-S19P19-0017, REQ-QUIC-RFC9000-S3P2-0013, REQ-QUIC-RFC9000-S3P2-0014, REQ-QUIC-RFC9000-S3P2-0019, REQ-QUIC-RFC9000-S3P2-0020, REQ-QUIC-RFC9000-S3P5-0010, REQ-QUIC-RFC9000-S3P5-0012, REQ-QUIC-RFC9000-S3P5-0013, REQ-QUIC-RFC9000-S4-0005, REQ-QUIC-RFC9000-S4P5-0005, REQ-QUIC-RFC9000-S4P5-0006.
...
- New proof or implementation work: 1018 requirements. Examples: REQ-QUIC-RFC9000-S10P1P2-0001, REQ-QUIC-RFC9000-S10P3P2-0010, REQ-QUIC-RFC9000-S10P3P2-0012, REQ-QUIC-RFC9000-S11-0003, REQ-QUIC-RFC9000-S11-0004, REQ-QUIC-RFC9000-S11P1-0001, REQ-QUIC-RFC9000-S11P1-0002, REQ-QUIC-RFC9000-S11P1-0003, REQ-QUIC-RFC9000-S11P1-0007, REQ-QUIC-RFC9000-S11P1-0008, REQ-QUIC-RFC9000-S12P1-0001, REQ-QUIC-RFC9000-S12P1-0002.
- Blocked by recorded gap families: 128 requirements. Examples: REQ-QUIC-RFC9000-S10-0001, REQ-QUIC-RFC9000-S10-0002, REQ-QUIC-RFC9000-S10P2-0002, REQ-QUIC-RFC9000-S10P2-0003, REQ-QUIC-RFC9000-S10P2-0005, REQ-QUIC-RFC9000-S10P2-0007, REQ-QUIC-RFC9000-S10P2-0008, REQ-QUIC-RFC9000-S10P2-0011, REQ-QUIC-RFC9000-S10P2-0012, REQ-QUIC-RFC9000-S10P2P1-0001, REQ-QUIC-RFC9000-S10P2P1-0002, REQ-QUIC-RFC9000-S10P2P1-0003.
...
| RFC9000 | 1443 | 435 | 50 | 174 | 275 | 103 | 406 |
| RFC9001 | 61 | 19 | 12 | 0 | 14 | 16 | 0 |
