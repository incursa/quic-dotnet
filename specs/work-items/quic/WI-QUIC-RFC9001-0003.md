...
- Keep repeated old/current/next epoch selection and second-successor packet handling blocked until the remaining timing/AEAD-policy subset above is proven.
