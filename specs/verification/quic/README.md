...
- [`VER-QUIC-INT-0011.json`](VER-QUIC-INT-0011.json): canonical non-HTTP/3 interop-testcase inventory verification source
- [`VER-QUIC-INT-0012.json`](VER-QUIC-INT-0012.json): canonical major peer interop matrix verification source
...
- [`VER-QUIC-INT-0027.json`](VER-QUIC-INT-0027.json): canonical local performance lane verification source
...
- [`VER-QUIC-API-0008.json`](VER-QUIC-API-0008.json): canonical public resumption-only transport API verification source
...
- [`VER-QUIC-CRT-0053.json`](VER-QUIC-CRT-0053.json): canonical CRT QUIC and HTTP/3 metrics verification source
- [`VER-QUIC-CRT-0055.json`](VER-QUIC-CRT-0055.json): canonical bounded runtime-shard metrics verification source
- [`VER-QUIC-CRT-0056.json`](VER-QUIC-CRT-0056.json): canonical queued application-send residence diagnostics verification source
