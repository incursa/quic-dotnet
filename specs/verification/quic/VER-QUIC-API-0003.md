...
# VER-QUIC-API-0003 - Incursa.Quic Explicit Pinned Identity and Trust-Material Client Policy Verification
...
- specs/architecture/quic/ARC-QUIC-API-0003.json
- specs/work-items/quic/WI-QUIC-API-0003.json
