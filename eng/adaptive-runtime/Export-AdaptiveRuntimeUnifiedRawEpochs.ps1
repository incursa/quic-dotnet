...
$rawSchemaPath = Join-Path $RepositoryRoot 'schemas\adaptive-runtime-unified-epoch-raw-v13.schema.json'
...
$manifestSchemaPath = Join-Path $RepositoryRoot 'schemas\adaptive-runtime-unified-raw-export-manifest-v14.schema.json'
$legacyManifestSchemaPath = Join-Path $RepositoryRoot 'schemas\adaptive-runtime-unified-raw-export-manifest-v13.schema.json'
...
$manifest = [ordered]@{
    schemaVersion = 'adaptive-runtime-unified-raw-export-manifest-v14'
    createdUtc = (Get-Date).ToUniversalTime().ToString('o')
    rawEpochSchemaVersion = 'adaptive-runtime-unified-epoch-raw-v13'
...
$legacyManifest.schemaVersion =
    'adaptive-runtime-unified-raw-export-manifest-v13'
...
if (-not (
        $legacyManifestJson |
            Test-Json `
                ...
                -ErrorAction Stop)) {
    throw 'Unified adaptive-runtime v13 manifest base projection failed schema validation.'
}
...
[ordered]@{
    schemaVersion = 'adaptive-runtime-unified-raw-export-result-v14'
