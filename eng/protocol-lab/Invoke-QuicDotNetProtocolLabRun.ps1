    ...
    switch ($Target) {
        ...
        "RawQuic" {
            return [pscustomobject]@{
                ...
                ScenarioIds = @("quic.transport.stream-throughput.1mb", "quic.transport.multiplex.100x64kb", "quic.transport.duplex-streams", "quic.transport.duplex-streams-peer-matrix")
                SupportedSuiteIds = @("quic-transport-v1-comparison")
                SupportedScenarioIds = @("quic.transport.stream-throughput.1mb", "quic.transport.multiplex.100x64kb", "quic.transport.duplex-streams", "quic.transport.duplex-streams-peer-matrix")
