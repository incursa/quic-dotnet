...
`VER-QUIC-RFC9220-0018` now records the repeatable RFC9220 WebSocket local-loopback peer proof. `pwsh -NoProfile -File scripts/proofs/Invoke-Rfc9220WebSocketLocalPeerProof.ps1 -RunId 20260619T0124Z-local-peer` passed one aggregate test and wrote `.artifacts/http3-websocket-local-peer/20260619T0124Z-local-peer`, covering Extended CONNECT setup, accepted metadata, server ping/client pong helper behavior, text exchange, buffered 6000-byte binary exchange, client close, and server close echo. Evidence class is `local-loopback-peer`; external WebSocket-over-H3 peer proof, isolated-host proof, publishable evidence, and production proxy policy remain out of scope. Manifest SHA256 `EA455456126832B995F2B6C7D06B3610A346675D0CDEC145FE927264B6AC4640`; report SHA256 `8C7D4C836D66D6C7DFEEA3AAF67367EFFD282DC13ED77485D6E1270B27B075B3`; TRX SHA256 `362E45D69E541EF7AF10CB23DCAD0E7E514F44E4B1E8BE7FCA48292256A42ADD`.
