...
CodeQL workflows also passed on `main` through commit `b03f879e`. A manual hosted
...
| `dotnet tool run workbench -- --format json validate --profile core` | Passed on 2026-04-30: 0 errors, 0 warnings, 101 work items, 317 markdown files |
...
|---|---:|---:|
| Architecture | 97 implemented | 3 draft |
| Work items | 98 complete | 3 planned |
| Verification | 99 passed | 3 planned |
...
- Hosted CI and CodeQL workflows passed on `main` at commit `b03f879e`
  (`25149446012` and `25149445624`).
