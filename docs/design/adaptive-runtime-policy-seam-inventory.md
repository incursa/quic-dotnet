...
raw-host export, and permanent-runner epoch joins implemented; one local
shadow cell and one retained-negative observation-neutrality cell executed;
broader campaigns and active policy blocked
