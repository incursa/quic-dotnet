...
FIN/reset/close, cancellation, or terminal behavior. With both ordinary Stage
3 axes implemented, the next independent implementation decision is Stage 4
