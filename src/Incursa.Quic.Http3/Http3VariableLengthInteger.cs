...
/// <summary>
/// Parses and formats QUIC variable-length integers for HTTP/3 payloads.
/// </summary>
public static class Http3VariableLengthInteger
{
    ...
    /// <summary>
    /// Gets the largest value representable by QUIC variable-length integer encoding.
    /// </summary>
    public const ulong MaxValue = 0x3FFF_FFFF_FFFF_FFFFUL;

    /// <summary>
    /// Gets the maximum encoded length of a QUIC variable-length integer.
    /// </summary>
    public const int MaxEncodedLength = EightByteEncodedLength;
    ...
    {
        if (!TryGetEncodedLength(value, out int length))
        {
